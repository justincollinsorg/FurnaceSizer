 ...
 */
class AddCategoryAttributeDisableInheritance implements DataPatchInterface
{
    /**
     * constant
     */
    const ATTRIBUTE_CODE = 'disable_subcategory_inheritance';
    ...
    public function apply()
    {
        try {
            ...
            $eavSetup->addAttribute(Category::ENTITY, self::ATTRIBUTE_CODE, [
                'type'     => 'int',
                'label'    => 'Disable Subcategory Inheritance',
                'input'    => 'boolean',
