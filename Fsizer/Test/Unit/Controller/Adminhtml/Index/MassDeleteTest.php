...
use Ecommerce121\Fsizer\Controller\Adminhtml\Index\MassDelete;
...
class MassDeleteTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->object = new MassDelete($context,$filter,$collectionFactory);
    }

    public function testMassDelete(): void
    {
        $this->assertEquals(true, method_exists($this->object, 'execute'));
        $this->assertEquals(class_parents(MassDelete::class), class_parents($this->object));
    }
}
