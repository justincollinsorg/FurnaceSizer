...
use Ecommerce121\Fsizer\Block\Adminhtml\Fsizer\BackButton;
...
class BackButtonTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        $this->object = new BackButton($context,$fsizerRepositoryInterface);
    }

    public function testBackButton(): void
    {
        $this->assertEquals(true, method_exists($this->object, 'getButtonData'));
        $this->assertEquals(class_parents(BackButton::class), class_parents($this->object));
    }
}
